    ...
    <>
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_auto_1fr] lg:items-center">
          <div>
            ...
            <div className="mt-7 flex flex-wrap items-center gap-3">
              <Link
                to="/projects"
                className="inline-flex items-center gap-2 rounded-full bg-primary py-3 pl-6 pr-1.5 text-sm font-semibold text-primary-foreground transition hover:opacity-90"
              >
                View My Work
            ...
            <div className="mt-8 flex items-center gap-4">
              ...
              <div className="grid h-11 min-w-11 place-items-center rounded-full bg-primary px-3 text-sm font-bold text-primary-foreground">
                50+
              </div>
      ...
      <section className="container-x py-16 md:py-20">
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-8 grid grid-cols-2 gap-4 sm:grid-cols-4">
              {services.slice(0, 8).map((s, i) => {
                ...
                return (
                  <div
                    key={s.name}
                    className="group rounded-2xl border border-border bg-card p-5 text-center transition hover:border-primary hover:shadow-md"
                  >
            ...
            <Link
              to="/services"
              className="mt-8 inline-flex items-center gap-2 rounded-full border border-border bg-background px-6 py-3 text-sm font-semibold transition hover:border-primary hover:text-primary"
            >
              View All Services
      ...
      <section className="container-x py-16 md:py-20">
        <div className="flex flex-wrap items-end justify-between gap-4">
          ...
          <Link
            to="/projects"
            className="inline-flex items-center gap-2 rounded-full bg-primary py-2.5 pl-5 pr-1 text-sm font-semibold text-primary-foreground"
          >
            View All Projects
      ...
      <CTABand
        ...
        text="Have a project in mind or want to work together? I'd love to hear from you."
...
function TimelineCard({
  ...
  title: string;
  items: { title: string; org: string; when: string }[];
}) {
  return (
        ...
        {items.map((it) => (
          <li key={it.title} className="relative">
            ...
            <div className="flex items-start justify-between gap-2">
              ...
              <span className="rounded-full bg-ink px-2.5 py-1 text-[10px] font-medium text-ink-foreground whitespace-nowrap">
                {it.when}
              </span>
            </div>
          </li>
  ...
  return (
    <section className="container-x pb-16">
      <div className="flex flex-col items-center gap-6 rounded-2xl border border-border bg-surface p-8 md:flex-row md:justify-between">
        ...
        <Link
          to="/contact"
          className="inline-flex items-center gap-2 rounded-full bg-ink py-3 pl-6 pr-1.5 text-sm font-semibold text-ink-foreground transition hover:bg-primary"
        >
          {buttonLabel}
