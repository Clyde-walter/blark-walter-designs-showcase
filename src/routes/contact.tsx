...
export const Route = createFileRoute("/contact")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Get in touch with Clyde Walter to start your UI/UX, brand, or frontend project.",
      },
          ...
          >
            ...
            <div className="mt-6 grid gap-4">
              ...
              <button
                ...
                type="submit"
                className="inline-flex items-center justify-center gap-2 rounded-full bg-primary py-3 pl-6 pr-1.5 text-sm font-semibold text-primary-foreground disabled:opacity-60"
              >
                {status === "sending" ? (
                  <>
